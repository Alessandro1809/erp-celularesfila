...
const LoginCustomer = () => {
    return (
        ...
        <section className="flex flex-col justify-center items-center transition-all animate-blurred-fade-in duration-1000 w-full h-screen md:container md:mx-auto px-4">
            ...
            <article className="flex mt-10 bg-gradient-to-b from-[#82F7FF]/[17%] to-transparent rounded-md border border-[#38FF88] p-4 w-full md:w-2/4">
                <form className="flex flex-col w-full space-y-3 rounded-md text-[#DBFF5E] p-4">
                    ...
                    <div className="flex justify-center">
                        <LoginButton name="Iniciar Sesion" action={handleSubmit}/>    
                    </div>    
            ...
            <article className="absolute bottom-4 left-4 text-sm text-white">
                <p>
                    ¿Problemas al iniciar sesión? <a href="#" className="text-[#DBFF5E]">Restablece tu contraseña</a>
                </p>
            </article>
        </section>
        </>
